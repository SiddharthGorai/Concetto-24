...
class MainStageFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val imageUrls2022 = listOf("https://res.cloudinary.com/dimf24hn7/image/upload/v1727125582/A_short_glimpse_of_the_EDM_night_held_at_Amber_ground_which_marked_the_ending_of_Concetto_22_-_The_Annual_Techno_Management_Festival_of_IIT_ISM_Dhanbad._.__swattrexmusic___djmerlin_official___con_uz7zwt.jpg"
